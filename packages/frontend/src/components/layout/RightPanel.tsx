...
export default function RightPanel() {
  ...
  if (type === 'leg' && legId && flightId) {
    return (
      <div data-tutorial="right-panel" className="w-full h-full bg-fp-panel border-l border-fp-border flex flex-col overflow-hidden">
  ...
  return (
    <div data-tutorial="right-panel" className="w-72 bg-fp-panel border-l border-fp-border flex flex-col overflow-hidden">
